...
- I share all the macros I use with the app [here](km). My most used macro from all of them is a macro to open Safari browser which I've ran some 117,091 times since I made it.

<img src="https://i.imgur.com/09KfToP.png" width="400" alt="img">
